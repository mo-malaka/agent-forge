...
import {
  handleSyntheticAccountsRequest,
  handleSyntheticEntitlementsRequest,
} from "@/lib/api/synthetic-web-services-route";
...
export async function GET(request: NextRequest, context: RouteContext) {
  ...
  return handleSyntheticAccountsRequest(request, slug);
}
